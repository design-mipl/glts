...
import { publicLayout, publicTypography, publicFonts, usePublicBrandColors } from '../../../theme/publicSiteTokens'
        ...
        <Grid container spacing={3}>
          {[
            ...
            <Grid size={{ xs: 12, md: 6 }} key={q}>
              ...
              >
                <Typography sx={{ fontWeight: 700, color: colors.navy, fontSize: '18px', mb: 1.5 }}>{q}</Typography>
                <Typography sx={{ color: colors.textSecondary, fontSize: publicTypography.body, lineHeight: 1.7 }}>{a}</Typography>
              </Box>
            </Grid>
          ))}
        </Grid>
