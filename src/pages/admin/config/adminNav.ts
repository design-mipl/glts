...
export const adminNav: NavConfig[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { type: 'item', label: 'Service', href: '/admin/masters/services' },
    ],
  },
  {
    type: 'group',
    ...
    children: [
      { type: 'item', label: 'Users', href: '/admin/access/users' },
      { type: 'item', label: 'Roles & permissions', href: '/admin/access/roles' },
    ],
  },
  {
    type: 'group',
