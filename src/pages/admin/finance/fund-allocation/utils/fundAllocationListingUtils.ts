...
import { formatSettlementAmountLabel } from '@/shared/utils/fundSettlementDisplay'
...
export function getFundAllocationClaimSheetCellValue(row: GroundOpsClaimSheet, key: string): string {
  switch (key) {
    ...
    case 'fundTransferType':
      return getClaimSheetFundTransferLabel(row.fundTransferType)
    case 'generatedBy':
