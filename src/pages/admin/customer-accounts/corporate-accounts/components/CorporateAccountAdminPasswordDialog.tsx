...
import type { CorporateAdminUser } from '@/shared/types/corporateAccount'
import { generateTemporaryPassword } from '@/shared/utils/corporateAccountValidation'

interface CorporateAccountAdminPasswordDialogProps {
  open: boolean
  admin?: CorporateAdminUser
  onClose: () => void
  onConfirm: (password: string) => void
  loading?: boolean
}

export function CorporateAccountAdminPasswordDialog({
  open,
  admin,
  onClose,
  onConfirm,
  loading = false,
}: CorporateAccountAdminPasswordDialogProps) {
  ...
  return (
    <Modal
      ...
      subtitle={
        admin
          ? `Set a new portal password for ${admin.fullName}.`
