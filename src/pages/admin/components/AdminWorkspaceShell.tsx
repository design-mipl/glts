...
export interface AdminWorkspaceSectionNavItem {
  id: string
  label: string
  complete?: boolean
}
...
export interface AdminWorkspaceShellProps {
  ...
  footer: ReactNode
  /** When false, omits the title card above the workspace (parent renders context). */
  showTitleCard?: boolean
  /** When true, omits breadcrumb chrome (parent already renders AdminRecordPageChrome). */
...
export function AdminWorkspaceShell({
  ...
  return <AdminRecordPageChrome breadcrumbs={breadcrumbs}>{workspaceBody}</AdminRecordPageChrome>
}
