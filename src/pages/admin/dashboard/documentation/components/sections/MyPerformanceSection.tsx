...
import type { DocumentationPerformanceMetric } from '../../data/documentationDashboardMock'

function PerformanceKpiCard({ metric }: { metric: DocumentationPerformanceMetric }) {
