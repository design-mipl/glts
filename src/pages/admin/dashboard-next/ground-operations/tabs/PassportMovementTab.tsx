...
export function PassportMovementTab({
  data,
  loading,
  onRetry,
  onNavigate,
  ...
  return (
    <Grid container spacing={DASHBOARD_SPACING.field}>
      ...
      <Grid size={{ xs: 12, md: 7 }}>
        <DashboardTable
          title="Passport & document movement"
          subtitle="In transit · awaiting collection · delivered · embassy · courier"
          columns={columns}
