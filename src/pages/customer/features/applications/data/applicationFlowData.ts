...
export const mockSingleApplications: SingleApplicationRow[] = [
  ...
  singleRow({
    ...
    processingStage: 'Ready for submission',
    operationalStatus: 'Draft',
    createdByEmail: 'crew@balticmanning.com',
    createdByRole: 'booker',
    customerSegment: 'marine',
  }),
  singleRow({
  ...
  singleRow({
    ...
    tentativeCollectionDate: '2026-05-01',
  ...
  singleRow({
    ...
    tentativeCollectionDate: '2026-04-28',
...
export const mockBulkBatches: BulkBatchRow[] = [
  ...
  bulkRow({
    ...
    processingStage: 'Embassy processing',
    operationalStatus: 'Under Review',
    createdByEmail: 'traveldesk@horizontech.com',
    createdByRole: 'admin',
    customerSegment: 'corporate',
    assignedTeamId: 'team-corporate',
    assignedUserId: 'user-corporate-1',
  ...
  bulkRow({
    ...
    createdByEmail: 'desk@voyagepartners.com',
    createdByRole: 'booker',
    customerSegment: 'b2bAgents',
    assignedTeamId: 'team-b2b-agent',
    assignedUserId: 'user-b2b-1',
