...
import { PublicContainer } from '../../PublicWebsite/components/PublicContainer'
import {
  publicColors,
  publicLayout,
  publicTypography,
...
export function CorporateLandingPage() {
  return (
    <Box>
          ...
          <Grid container spacing={6} alignItems="center">
            <Grid size={{ xs: 12, md: 6 }}>
              ...
              <Stack direction={{ xs: 'column', sm: 'row' }} spacing={2}>
                <Button variant="contained" size="large" sx={{ ...primaryButtonSx, px: 4, py: 1.5 }}>
                  Book a demo
                </Button>
                <Button
                  variant="outlined"
      ...
      <Box sx={{ py: publicLayout.sectionMajor, backgroundColor: publicColors.surface }}>
        <PublicContainer>
          <Box sx={{ textAlign: 'center', mb: 6 }}>
            <Typography sx={{ fontWeight: 800, fontFamily: publicFonts.heading, color: publicColors.navy, fontSize: publicTypography.h2, mb: 1 }}>
              ...
              <Grid size={{ xs: 12, sm: 6, md: 4 }} key={title}>
                <Card
                  sx={{
                    ...
                    height: '100%',
                    transition: 'all 0.3s',
                    '&:hover': { boxShadow: publicShadows.cardHover, borderColor: publicColors.greenBright },
                  }}
                >
                  <Box
                    sx={{
      ...
      <Box sx={{ py: publicLayout.sectionMajor, backgroundColor: publicColors.navy }}>
        <PublicContainer>
      ...
      <Box sx={{ py: publicLayout.sectionMajor, backgroundColor: publicColors.surface }}>
        <PublicContainer sx={{ textAlign: 'center', maxWidth: 720 }}>
          ...
          <Stack direction={{ xs: 'column', sm: 'row' }} spacing={2} justifyContent="center">
            <Button variant="contained" size="large" sx={{ ...primaryButtonSx, px: 5, py: 1.75 }}>
              Book a demo
            </Button>
            <Button
              variant="outlined"
