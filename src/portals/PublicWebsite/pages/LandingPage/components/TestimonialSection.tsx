...
export function TestimonialSection() {
  return (
    <Box sx={{ py: publicLayout.sectionMedium, backgroundColor: publicColors.surface }}>
      <PublicContainer>
          ...
          <Grid size={{ xs: 12, lg: 7 }}>
            ...
            >
              ...
              <Stack direction="row" alignItems="center" spacing={2}>
                <Avatar sx={{ width: 48, height: 48, bgcolor: publicColors.greenBright, fontWeight: 700 }}>
                  HK
                </Avatar>
                <Box>
            ...
            <Stack spacing={3} sx={{ height: '100%' }}>
              {stats.map(({ value, label }) => (
                ...
                >
                  ...
                  <Typography sx={{ color: publicColors.textSecondary, fontSize: publicTypography.body, fontWeight: 500 }}>
                    {label}
                  </Typography>
                </Card>
              ))}
