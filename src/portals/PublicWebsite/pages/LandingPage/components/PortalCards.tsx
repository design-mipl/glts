...
import { publicColors, publicLayout, publicTypography, publicFonts, primaryButtonSx } from '../../../theme/publicSiteTokens'

export function PortalCards() {
  return (
    <Box>
      <Box sx={{ backgroundColor: publicColors.navy, py: publicLayout.sectionMedium }}>
        <PublicContainer>
      ...
      <Box sx={{ backgroundColor: '#fff', py: publicLayout.sectionMedium, borderBottom: `1px solid ${publicColors.border}` }}>
        <PublicContainer>
            ...
            <Grid size={{ xs: 12, md: 6 }} order={{ xs: 1, md: 2 }}>
              ...
              <Button
                ...
                sx={{
                  ...
                  px: 4,
                  '&:hover': { bgcolor: publicColors.navyMid },
                }}
              >
                Set up your team
              </Button>
