  ...
  return (
    <Box
      ...
      sx={{
        ...
        background: `linear-gradient(180deg, ${publicColors.surface} 0%, #fff 100%)`,
      }}
    >
      <PublicContainer>
        <Box sx={{ maxWidth: 720, mb: { xs: 8, md: 10 } }}>
          ...
          <Typography sx={{ fontSize: publicTypography.bodyLg, color: publicColors.textSecondary, lineHeight: 1.75 }}>
                ...
                >
                  <Box
                    sx={{
                      ...
                      bgcolor: isDone
                        ? publicColors.greenBright
                        : isActive
                          ? publicColors.navy
                          : publicColors.surfaceAlt,
                      color: isDone || isActive ? '#fff' : publicColors.textMuted,
                      boxShadow: isActive ? '0 8px 24px rgba(0,31,63,0.2)' : 'none',
                      border: isActive ? `2px solid ${publicColors.greenBright}` : 'none',
                    }}
                  >
                  ...
                  <Typography
                    sx={{
                      fontSize: '13px',
                      fontWeight: 600,
                      color: isActive ? publicColors.navy : publicColors.textSecondary,
                      textAlign: 'center',
                      maxWidth: 100,
                    }}
                  >
        ...
        <Grid container spacing={4} sx={{ mt: { xs: 6, md: 8 } }}>
          {[
            ...
            <Grid size={{ xs: 12, md: 4 }} key={item.title}>
              <Box sx={{ p: 4, borderRadius: '18px', bgcolor: publicColors.surface, height: '100%' }}>
                <Typography
                  sx={{
                    fontFamily: publicFonts.heading,
                    fontWeight: 700,
