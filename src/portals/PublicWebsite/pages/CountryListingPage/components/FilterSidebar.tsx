...
import { publicColors, publicLayout, publicShadows } from '../../../theme/publicSiteTokens'
  ...
  return (
    ...
    >
      <Box sx={{ display: 'flex', justifyContent: 'space-between', mb: 4 }}>
        <Typography sx={{ fontWeight: 700, fontSize: '14px', color: publicColors.navy, letterSpacing: '0.5px' }}>
          FILTERS
        </Typography>
        <Button
          size="small"
          onClick={() => onFiltersChange({ regions: [], priceRange: [0, 20000], visaTypes: [] })}
          sx={{ color: publicColors.greenBright, fontWeight: 600, textTransform: 'none', minWidth: 'auto' }}
        >
          Reset
        </Button>
      </Box>
      ...
      <Box sx={{ mb: 5 }}>
        <Typography sx={{ fontSize: '12px', fontWeight: 700, color: publicColors.textMuted, mb: 2 }}>
          REGION
        </Typography>
        <FormGroup>
            ...
            <FormControlLabel
              ...
              control={
                <Checkbox
                  ...
                  sx={{ '&.Mui-checked': { color: publicColors.greenBright } }}
                />
              }
      ...
      <Box>
        ...
        <Slider
          ...
          max={20000}
          step={500}
          sx={{ color: publicColors.greenBright, mb: 2 }}
        />
        <Typography sx={{ fontSize: '14px', color: publicColors.textSecondary }}>
