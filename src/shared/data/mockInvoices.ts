...
export const SEED_INVOICES: Invoice[] = [
  ...
  withAdjustment({
    ...
    totals: { subtotal: 2000, gstTotal: 360, tdsAmount: 47.2, additionalCharges: 0, finalAmount: 2312.8, advanceAvailable: 0, advanceAdjusted: 0, creditApplied: 0, balancePayable: 1312.8 },
