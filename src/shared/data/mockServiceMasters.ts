...
export const SEED_SERVICE_MASTERS: ServiceMaster[] = [
  ...
  {
    id: 'svc-glts-consultation',
    serviceCode: 'SVC-CON-041',
    serviceType: 'glts',
    serviceName: 'GLTS Consultation',
    description: 'GLTS advisory consultation for travel, visa, and compliance guidance',
    category: 'Consultation',
    subcategory: 'Travel Advisory',
    defaultPrice: 2000,
    mappedSacCodeId: 'sac-998599',
    gstRateId: 'gst-12',
    tdsSectionId: null,
  ...
  {
    id: 'svc-photo-charges',
    serviceCode: 'SVC-FEE-003',
    serviceType: 'glts',
    serviceName: 'Photo Charges',
    description: 'Passport and visa photo charges',
    category: 'Documentation',
    subcategory: 'Document Verification',
    defaultPrice: 300,
    mappedSacCodeId: 'sac-998514',
  ...
  {
    id: 'svc-print-out-charges',
    serviceCode: 'SVC-FEE-004',
    serviceType: 'glts',
    serviceName: 'Print Out Charges',
    description: 'Document print-out and photocopy charges',
    category: 'Documentation',
    subcategory: 'Document Verification',
    defaultPrice: 200,
    mappedSacCodeId: 'sac-998514',
  ...
  {
    id: 'svc-urgent-charges',
    serviceCode: 'SVC-FEE-005',
    serviceType: 'glts',
    serviceName: 'Urgent Charges',
    description: 'Urgent / priority handling surcharge',
    category: 'Consultation',
    subcategory: 'Travel Advisory',
    defaultPrice: 2500,
    mappedSacCodeId: 'sac-998599',
