...
export const SEED_COMMERCIAL_AGREEMENTS: CommercialAgreement[] = [
    ...
    miscellaneousServices: [
      {
        ...
        serviceName: 'Courier Charges',
        amount: 500,
        gstApplicable: true,
      },
      {
        id: 'misc-001-airport',
        serviceId: 'svc-airport-assistance',
        serviceName: 'Airport Assistance',
        amount: 1200,
        gstApplicable: true,
      },
    ],
  ...
  {
    id: 'AGR-SF-029',
    agreementId: 'AGR-2026-SF-029',
    companyId: 'CMP-SF-029',
    ...
    entities: [
      {
        id: 'ent-sf-1',
        entityName: 'Seafarer Solutions Mumbai',
        billingAddress: 'Andheri East, Mumbai 400069',
        gstNumber: '27AABCS0290A1Z1',
        contactPerson: 'Andreas Klein',
        email: 'billing@seafarersolutions.com',
        phone: '+91 9811122233',
        status: 'active',
      },
    ],
    pricingMatrix: [],
    miscellaneousCosts: [
      { id: 'mc-sf-1', serviceName: 'Courier Charges', pricingType: 'fixed', amount: 600, gstApplicable: true, remarks: '' },
    ],
    commercialVisaPricing: [
      {
        id: 'cvr-sf-france-crew',
        scope: 'country',
        countryId: 'CNT-104',
        country: 'France',
        visaType: 'Crew · Type C',
    ...
    financeContacts: {
      accountsSpocName: 'Andreas Klein',
      accountsTeamEmail: 'billing@seafarersolutions.com',
      accountsContactNumber: '+91 9811122233',
      invoiceSubmissionEmail: 'invoices@seafarersolutions.com',
      paymentFollowUpContact: 'finance@seafarersolutions.com',
    },
    documents: seededDocs('agreemented', 'marine', { fileSuffix: 'seafarer', uploadedDaysAgo: 4 }),
    createdAt: daysAgo(45),
    updatedAt: daysAgo(2),
  ...
  {
    id: 'AGR-AM-039',
    agreementId: 'AGR-2026-AM-039',
    companyId: 'CMP-AM-039',
    ...
    billingType: 'credit',
    status: 'active',
    startDate: daysAgoDate(50),
    endDate: daysFromNow(315),
    entities: [
      {
        id: 'ent-am-1',
        entityName: 'Atlantic Manning UK Ltd',
        billingAddress: 'Canary Wharf, London E14 5AB',
        gstNumber: '',
        contactPerson: 'Amelia Clarke',
        email: 'ops@atlanticmanning.uk',
    ...
    financeContacts: {
      accountsSpocName: 'Amelia Clarke',
      accountsTeamEmail: 'accounts@atlanticmanning.uk',
      accountsContactNumber: '+44 20 7946 0958',
      invoiceSubmissionEmail: 'invoices@atlanticmanning.uk',
      paymentFollowUpContact: 'finance@atlanticmanning.uk',
    },
    documents: seededDocs('agreemented', 'marine', { fileSuffix: 'atlantic-manning', uploadedDaysAgo: 5 }),
    createdAt: daysAgo(50),
    updatedAt: daysAgo(3),
    activatedAt: daysAgo(48),
    activities: [],
  },
  {
    id: 'AGR-VP-024',
    agreementId: 'AGR-2026-VP-024',
    companyId: 'CMP-VP-024',
    ...
    entities: [
      {
        id: 'ent-vp-1',
        entityName: 'Voyage Partners Agency Pvt Ltd',
        billingAddress: 'BKC, Mumbai 400051',
        gstNumber: '27AABCV0240A1Z8',
        contactPerson: 'Aisha Khan',
        email: 'desk@voyagepartners.com',
        phone: '+91 9822233344',
        status: 'active',
      },
    ],
    ...
    financeContacts: {
      accountsSpocName: 'Aisha Khan',
      accountsTeamEmail: 'accounts@voyagepartners.com',
      accountsContactNumber: '+91 9822233344',
